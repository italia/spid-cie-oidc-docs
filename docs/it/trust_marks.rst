...
All’interno della Federazione SPID i Trust Mark presentano degli identificativi univoci (claim id) in formato URL che adottano la seguente struttura: **https:// <domain> / <trustmark_entity_type> / [<trustmark_profile> /] [estensione /]**
...
La tabella seguente definisce i <trustmark_entity_type> riconoscibili all'interno delle Federazioni SPID e CIE id:
