...
I **Trust Mark (TM)**, letteralmente tradotti come *Marchi di Fiducia*, sono oggetti JWT firmati :rfc:`7515` e rappresentano la dichiarazione di conformità a un insieme ben definito di requisiti di fiducia e/o di interoperabilità o un accordo tra le parti coinvolte all’interno della Federazione. 
