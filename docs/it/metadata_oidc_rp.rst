...
.. list-table:: 
  ...
  * - **id_token_encrypted_response_alg**
    - Vedi `OpenID.Registration#ClientMetadata`_. Opzionale per Cie id. Obbligatorio per SPID. Se questo parametro è incluso l'ID Token restituito sarà un *Nested JWT* firmato e cifrato come definito in :rfc:`OpenID.Core`_ Section 10.
    - |spid-icon| |cieid-icon| 
