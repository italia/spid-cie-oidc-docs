...
OIDC-FED utilizza ed estende i claim dei Metadata così come definiti all'interno delle specifiche di `OpenID.Discovery`_ e `OpenID.Registration`_ rispettivamente per OP e RP. 
