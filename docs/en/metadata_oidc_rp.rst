...
.. list-table:: 
  ...
  * - **id_token_encrypted_response_alg**
    - See `OpenID.Registration#ClientMetadata`_. This is optional. If this is requested, the response will be signed then encrypted, with the result being a Nested JWT, as defined in :rfc:`7515#section-4`.
    - |spid-icon| |cieid-icon| 
